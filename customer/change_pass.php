<form action="" method="post">
	<table width="500" align="center">
		...
		<tr align="center">
			<td colspan="4"><h2>Change Your Pasword</h2></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="password" name="new_pass_again" id="confirm_pass" oncopy="return false" onpaste="return false" required=""></td>
		</tr>
		<tr align="center">
